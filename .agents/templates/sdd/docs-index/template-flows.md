...
- **Flujo 2 — `sdd install` (paquete → proyecto):** ✅ FUNCIONAL. `scaffold.js` copia `bootstrap/root`, `funky-ai-rules/` anidado (27 reglas), `sdd/*.md` y `custom-workflows/sdd/` → `docs/funky-ai/prompts/sdd/` al proyecto destino.
