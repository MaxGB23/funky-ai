...
- **Flujo 4 — Skills (paquete → proyecto):** ✅ FUNCIONAL (2026-08-03). `skills.js` copia `gentle/skills/` a `.agents/skills/` y los docs compartidos (`bootstrap/sdd/docs-live-index.md` + `docs-index/template.md`) con paridad de bytes respecto a scaffold (R-SK-5).
