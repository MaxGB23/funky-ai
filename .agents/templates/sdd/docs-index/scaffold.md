...
- **3. Árbol completo de inyección:** Estructura que materializa el ecosistema Funky AI.
  ...
  - **`.agents/templates/sdd/` (8 + 2 copiados):** 8 templates copiados más `docs-live-index.md` y `docs-index/template.md` copiados del template base compartido (`bootstrap/sdd/`, mismo src que `funky skills` — R-SK-5).
