...
- **3. Árbol completo de inyección:** Estructura que materializa el ecosistema Funky AI.
  ...
  - **`.agents/rules/` (27 archivos):** Reglas base (8), metodologías y exploración (3: `metodologias.md`, `sabueso-route-a.md`, `codegraph.md`), tier2-delegation (7, incluye `t2-apply.md`), tier3-interactive (8) y risk-decision (1).
  ...
  - **`docs/funky-ai/prompts/sdd/` — Workflows T3 (9 archivos):** Prompts custom workflows para subagentes nativos (antigravity CLI); fuente `bootstrap/custom-workflows/sdd/`.
