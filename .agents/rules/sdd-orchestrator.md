...
> Tú, como Orquestador, **TIENES PROHIBIDO** sugerir estos comandos o intentar usarlos para tareas regulares de Tier 1, 2 o 3. Nunca sugieras un workflow a menos que estemos explícitamente en Tier 4.
...
| `/sdd-ff` | **PRERREQUISITO:** Fases anteriores completas. **LUEGO:** `view_file tasks.md` (inyectado por CLI) y completarlo con `replace_file_content`. **PROHIBIDO** sobrescribir. |
...
Al recibir un `sdd-report.md`, DEBES extraer los bugs/gotchas del Worker y seguir este mismo proceso.
