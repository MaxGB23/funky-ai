...
Una vez que has ejecutado `funky sdd install` y tienes los archivos base, el Orquestador (o el Tech Lead humano) debe adaptar las plantillas siguiendo estos pasos:
