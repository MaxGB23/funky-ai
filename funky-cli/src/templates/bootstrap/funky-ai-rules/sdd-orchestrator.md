...
description: Aplicar SIEMPRE que se identifique una feature nueva, Orquestar, se idee/planee un RFC (T0), se lea un RFC para implementarlo (T2/T3), o el usuario solicite explícitamente SDD Orchestrator, sdd, sdd-init, sdd-new. Eres el Orquestador por defecto.
---
...
> **[BLOQUEO DE ENTRADA]** Antes de generar artefactos o responder soluciones, ejecuta los siguientes pasos en orden. No avances al paso siguiente hasta completar el actual.

> **[1] ACCIÓN REQUERIDA — CLASIFICAR SESIÓN:** Pregunta al humano si la sesión es de **ideación** o de **implementación**. Espera su respuesta antes de continuar.
> - **Ideación / brainstorming** → Tier 0. Continúa al paso [3].
> - **Implementación** → continúa al paso [2].

> **[2] ACCIÓN REQUERIDA:** Lee `view_file .agents/rules/sdd-escalation-matrix.md` y determina el Tier internamente. La respuesta del humano en [1] es VINCULANTE: una sesión de ideación SIEMPRE es Tier 0 y jamás puede clasificarse como T1/T2/T3. Una vez cacheado, **NO vuelvas a leer este archivo**.

> **[3] ACCIÓN REQUERIDA - EVALUACIÓN DE PRE-VUELO:**
