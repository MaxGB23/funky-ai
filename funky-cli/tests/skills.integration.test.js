...
describe('runSkills() Integration', () => {
  ...
  it('1ª ejecución: crea los 4 archivos (2 skills + 2 docs compartidos)', () => {
    const intentions = runSkills({ templatesDir, targetBase: tmpDir });
  ...
  it('docs fresh: docs-live-index.md bytes == template distribuido (R-SK-4)', () => {
    ...
    const templatePath = path.join(templatesDir, 'bootstrap/sdd/docs-live-index.md');
