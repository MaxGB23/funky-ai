...
| `funky feature <nombre>` | Inicializa el scaffolding completo para una nueva feature SDD en `openspec/changes/<nombre>`, copiando todos los templates necesarios. | `funky feature auth` -> "🚀 Scaffolding de feature creado..." |
