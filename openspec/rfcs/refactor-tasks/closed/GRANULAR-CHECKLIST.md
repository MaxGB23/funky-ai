...
### 📄 `draft-tasks.md`
- [x] **§1 — Resumen y Motivación** — Fragmentación del monolito `tasks` en `tasks.md`, `docs.md` y `release.md`.
- [x] **§2 — Reglas de Release (SemVer x SDD)** — Reglas de inyección de `release.md` y `docs.md` por SemVer. *(Consolidado en `spec-routing-tiers.md`)*
- [x] **§3 — Flujo de Inyección (Diagrama)** — Diagrama y lógica de Inquirers del CLI (`funky feature`).
- [x] **§4 — Orquestación y Decisión Humana (Inquirers)** — IA sugiere, humano aprueba o corrige.
- [x] **§5 — Custom Workflows y Exclusión de Templates** — Exclusión de scaffolding en T3/T4 con agentes libres.
- [x] **§6 — Escalera de Tiers y Aislamiento de Fases** — Jerarquía T1→T4. *(Consolidado en `spec-routing-tiers.md`)*
- [x] **§7.1 — Trazabilidad Vertical de NFRs** — Ciclo Discovery → Formalización → Bloqueo → Cascada → Tagging.
- [x] **§7.2 — Modos de Ejecución CLI: Automático vs Interactivo** — Ritmo de inyección y aprobación por fase.
- [x] **§7.3 — Escalera de Tiers Refinada (con T0)** — Tier 0 y Branch Management. *(Consolidado en `spec-routing-tiers.md`)*
- [x] **§7.4 — El "Explore Ligero" — Sabueso Desechable** — Ciclo de vida v1 (Canary) → v2 (Autónomo).
- [x] **§7.5 — Arquitectura del `/funky-tasks` y Deprecaciones** — Un solo workflow agnóstico al Tier, deprecación del Microplanning, Return Envelope. *(Consolidado en `spec-routing-tiers.md`)*

### 📄 `rules-orchestrator-backup.md`
- [x] **§Identidad** — Rol del Orquestador, prohibición de abuso de slash commands.
- [x] **§Escalation Matrix** — Tabla de routing por Tiers. *(Consolidado en `spec-routing-tiers.md`)*
