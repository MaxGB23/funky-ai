# Root Spec — Workflow Domain
> Domain: workflow | Status: Living | Source of Truth: `openspec/specs/workflow/spec.md`

This is the canonical living specification for the `workflow` domain.
