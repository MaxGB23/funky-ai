...
Para evitar que el cerebro de la IA se "sature" con mil archivos, dividimos el trabajo en dos personalidades:
...
3.  **`/sdd-ff` (Fast Forward)**: "Vamos directo al grano". Crea el `tasks.md` con todas las fases de ejecución.

---

## 🐣 4. Guía para Novatos: Cómo iniciar una Sesión Pro

Si quieres arrancar un chat nuevo y que yo sepa exactamente qué hacer, sigue estos pasos:

### Paso 1: El Contexto es Rey 👑
Nunca arranques un chat sin darme el estado actual. Lo primero que tienes que hacer es:
> *"Hola, eres mi Orquestador. Aquí tienes el estado: `@ORCHESTRATOR-STATE.md`"*
...
1.  Cierra el chat actual (para limpiar la memoria).
2.  Abre uno nuevo.
3.  Pega el archivo `worker-handoff.md` que generé y dime:
    > *"Ejecuta la Fase 1 de este handoff."*
...
**¡Adelante! Ahora ya tienes las llaves de la nave. ¡A lograrlo!**
