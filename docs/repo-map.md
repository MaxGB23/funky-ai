...
| `funky sdd install` | funky-ai | [`src/commands/sdd.js`](../funky-cli/src/commands/sdd.js) + alias deprecado [`src/commands/scaffold.js`](../funky-cli/src/commands/scaffold.js) | [`docs/funky-ai/sdd.md`](../docs/funky-ai/sdd.md) |
...
| Doc | Contenido |
|-----|-----------|
| [`sdd.md`](../docs/funky-ai/sdd.md) | Árbol completo de inyección del ecosistema agéntico (`funky sdd install`; alias deprecado `funky scaffold`) |
...
| `bootstrap/` | `funky sdd install` / `funky skills` | Reglas agénticas, templates SDD, ORCHESTRATOR-STATE, docs compartidos (docs-live-index, índice seccional) |
